...
class _ListPaginacaoWidgetState extends State<ListPaginacaoWidget> {
  Widget conteinerComOsPontos(dynamic pontosListaItem) {
    return Padding(
      padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 30.0),
      child: Builder(
        builder: (context) {
          final pontosLista = widget.trPontos!.toList();
          return Column(
            mainAxisSize: MainAxisSize.max,
            children: List.generate(pontosLista.length, (pontosListaIndex) {
              final pontosListaItem = pontosLista[pontosListaIndex];
              return Padding(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'Ops!'),
                                                                        content:
                                                                            Text('Ative a internet para ver a foto.'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Ops!'),
                                                                          content:
                                                                              Text('Não foi capturada foto para essa coleta!'),
                                                                          actions: [
                                                                            TextButton(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'Ops!'),
                                                                        content:
                                                                            Text('Não existe imagem capturada para essa coleta.'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext),
  ...
  Widget build(BuildContext context) {
    return ModestPagination(
      ...
      childWidget: (dynamic element) {
        ...
        return conteinerComOsPontos(element);
      },
    );
  }
}
